...
const Weather = ({ city }) => {
  ...
  useEffect(() => {
    fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=504e0165a3bcd365edb0f6986edbda69&units=metric`)
  ...
  return (
    <div>
      <p>{city}
        {temperature && <span style={{ color: "#ffe970" }} class="fs-5 text-right nav-link active">{temperature}°C</span>}
      </p>
    </div>
  );
};
...
export const Navbar = () => {
  return <div>
    <nav style={{ position: "fixed", top: "0", width: '100%', zIndex: "999" }} class="navbar navbar-expand-lg bg-dark">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <Link style={{ color: "orangered" }} class="nav-link disabled font-weight-bold"><CurrentDate /></Link>
            </li>
